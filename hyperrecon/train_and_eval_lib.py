...
from hyperrecon.uniform import UniformHypernetVariabilityPrior
...
def get_trainer(args):
  ...
  elif args.method.lower() == 'uniform_hypernet_variability_prior':
    trainer = UniformHypernetVariabilityPrior(args)
  else:
